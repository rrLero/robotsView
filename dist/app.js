    ...
    return {
        ...
        execute: function () {
            HTMLGeneratorService = /** @class */ (function () {
                ...
                HTMLGeneratorService.prototype.generate = function (unit, index) {
                    this.elId = 0;
                    this.index = index;
                ...
                HTMLGeneratorService.prototype.getClassName = function () {
                    ++this.elId;
                    return 'id' + this.elId + '_' + this.index;
                };
    ...
    return {
        ...
        execute: function () {
            StageService = /** @class */ (function () {
                ...
                StageService.prototype.addUnit = function (unit) {
                    this.arrUnits.push(unit);
                };
                StageService.prototype.removeUnit = function (unit) {
                    this.arrUnits = this.arrUnits.filter(function (el) { return (el !== unit); });
                };
